...
namespace Timesheet.Infrastructure
{
    ...
    /// </summary>
    /// <typeparam name="Context">Database context</typeparam>
        ...
        where TEntity:class, IDbEntity, new()
    {
        ...
        /// </summary>
        IQueryable<TEntity> AllNoTrack { get; }
        /// <summary>
        ...
        IQueryable<TEntity> FindBy(Expression<Func<TEntity, bool>> predicate, bool noTrack = true);
        /// <summary>
