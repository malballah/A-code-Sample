...
namespace Truck.Data.Repositories
{
    ...
    {
        private TruckDbContext _dataContext;

        #region Properties

        protected IDbFactory DbFactory { get; private set; }

        protected TruckDbContext DbContext => _dataContext ?? (_dataContext = DbFactory.Init());
        ...
        {
            return DbContext.Database.SqlQuery<TEntity>(query).AsQueryable<TEntity>();
        }
